...
async function extractPhonesWithLogic() {
  try {
    console.log('Telefon bilgileri çıkarılıyor (getPairRightOf mantığı ile)...\n');
    ...
    for (let row = 1; row <= worksheet.rowCount; row++) {
      ...
      if (customerCode) {
        ...
        const phoneNumber = getPairRightOf(rowData, 'Telefon');
